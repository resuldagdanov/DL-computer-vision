...
def get_CIFAR10_data(validation_ratio: float=0.02,
                     flatten: bool=False):
  """
...
def softmax_loss(x: torch.Tensor,
                 y: torch.Tensor):
  """
